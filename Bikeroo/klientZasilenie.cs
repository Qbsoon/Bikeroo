...
namespace Bikeroo
{
    public partial class klientZasilenie : Form
    {
        ...
        {
            if (decimal.TryParse(moneyAddText.Text, out decimal amount) && amount > 0)
            {
                amountToAdd = amount;
            ...
            {
                MessageBox.Show("Proszę wprowadzić poprawną kwotę.");
            }
        }
    }
}
